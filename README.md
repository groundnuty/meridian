...
| [Desktop app (development preview)](apps/desktop/README.md) | Optional macOS Electron app: monitoring, version management, plugin installation and service handoff |
