...
export interface Preferences { backend?: 'claude' | 'antigravity' | 'combined'; allowAntigravityTools?: boolean; mode: 'managed' | 'attached'; endpoint: string; port: number; selected?: string; previous?: string; autoStart: boolean; notifications: boolean; notificationCritical: boolean; notificationRequests: boolean; notificationCache: boolean; notificationQuota: boolean; openWindowAtLaunch: boolean; quietUntil: number; apiKey?: string }
