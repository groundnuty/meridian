...
function renderContent() {
  ...
  bindForm('provider-form', data => { void action('save-preferences', { backend: data.get('backend'), allowAntigravityTools: data.has('allowAntigravityTools'), persistAntigravityHistory: data.has('persistAntigravityHistory'), allowAntigravityBrowser: data.has('allowAntigravityBrowser'), allowAntigravitySubagents: data.has('allowAntigravitySubagents') }) })
