...
function renderContent() {
  ...
  bindForm('provider-form', data => { void action('save-preferences', { backend: data.get('backend'), allowAntigravityTools: data.has('allowAntigravityTools') }) })
